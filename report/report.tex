...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.1]{./images/blenderGUI.png}
...
\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.1]{./images/output_1.png}
  \caption{Image 1, RGB}
...
\begin{figure}[!h]
  ...
  \centering
  \includegraphics[scale=0.1]{./images/instance/output_1.png}
  \caption{Image 1, Segmentation mask}
\end{figure}

\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.1]{./images/output_131.png}
  \caption{Image 2, RGB}
...
\begin{figure}[!h]
  ...
  \centering
  \includegraphics[scale=0.1]{./images/instance/output_131.png}
  \caption{Image 2, Segmentation mask}
\end{figure}
...
\begin{figure}[!h]
  ...
  \centering
  \includegraphics[scale=0.1]{./images/UNET_architecture.png}
  \caption{UNET architecture}
\end{figure}

\subsection{Implementation}
% 4. Explain the loss function you used for training.
The model was trained on the dataset generated in Part 1. We are using the \textbf{cross-entropy} loss function. The hyperparameters used for training are shown in Table 1.
...
\subsection{Results}
Results for the model are in the vdeo "part2.mp4". Below are the loss curve per epoch plot:
\begin{figure}[!h]

  \centering
  \includegraphics[scale=0.5]{./images/batchlosstrainsemantic.png}
  \caption{Training loss curve, batch}
\end{figure}

\begin{figure}[!h]
  \centering
  \includegraphics[scale=0.5]{./images/batchlossvalsemantic.png}
...
\begin{figure}[!h]
  ...
  \centering
  \includegraphics[scale=0.5]{./images/epochlossvalsemantic.png}
